...
const demoLinks = {
  ...
  ecommerce: {
    blue: `${DEMO_BASE_URL}?niche=ecom&theme=blue`,
    orange: `${DEMO_BASE_URL}?niche=ecom&theme=orange`,
    black: `${DEMO_BASE_URL}?niche=ecom&theme=black`,
    brand: `${DEMO_BASE_URL}?niche=ecom&theme=brand`,
  },
};
